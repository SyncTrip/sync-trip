...
const Lobby = () => {
    ...
    const handleCreateRoom = () => {
        ...
        roomCtrl.createRoom(code, {members: [user]})
            .then((room) => {
    ...
    const handleJoinRoom = () => {
        ...
        console.log('User:', user);
        roomCtrl.addUserToRoom(joinCode, user)
            .then((room) => {
    ...
    const handleRegister = () => {
        ...
        if (name) {
            userCtrl.createUser(randomCode(), {name: name})
                .then((user) => {
                    setRegistered(true);
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box style={{ display: 'flex', flexDirection: 'column', gap: '20px', alignItems: 'center', justifyContent: 'center' }}>
                    <input
                        type="text"
